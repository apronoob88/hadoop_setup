...
number_to_remove = int(input("please enter the number of nodes to remove (we strongly encourage you to remove one at a time): "))
...
try:
    ...
    cmd = f'python3 remove_node.py {cluster_name} {key_name} {number_to_remove} {key} {secrete_key} {session_token}'
